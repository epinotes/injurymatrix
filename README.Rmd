...
The R package **[injurymatrix](https://epinotes.github.io/injurymatrix/)** purpose is to facilitate the use of the [ICD-10-CM injury matrix](ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/injury/tools/) in data analysis. The online matrices were updated in October 2020.
...
`?injury_matrix_all` # the full matrix of 3,602 entries icd-10-cm of external causes of injury
